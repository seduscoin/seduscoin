...
This mechanism has been integrated into Bitcore-Node-Sedus which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/seduscoin/insight-api-sedus#web-socket-api](https://github.com/seduscoin/insight-api-sedus#web-socket-api)
* API: [https://github.com/seduscoin/insight-api-sedus#instantsend-transactions](https://github.com/seduscoin/insight-api-sedus#instantsend-transactions)
...
By default, the Sedus Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Sedus Core daemon:
