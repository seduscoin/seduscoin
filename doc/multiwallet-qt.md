...
Only requiring some minor changes is sedus.cpp.
...
Changes to sedus.cpp
----------------------
sedus.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
