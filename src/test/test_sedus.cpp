...
#define BOOST_TEST_MODULE Sedus Test Suite

#include "test_sedus.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_sedus_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
