 ...
 *
 *   // network
 *   CSedusNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.sedus.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSedusNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: SedusNetwork
// //   -- signature requirements : Key1(User)
// class CSedusNetworkVariable : public CGovernanceObject
// {
// private:
