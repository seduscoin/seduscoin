...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SedusNetwork") type = SedusNetwork;
    if(strType == "SedusNetworkVariable") type = SedusNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SedusNetwork) s = "SedusNetwork";
    if(type == SedusNetworkVariable) s = "SedusNetworkVariable";
