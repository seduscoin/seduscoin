...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Sedus related functionality
...
/*
    ...
    allow endless transaction that would bloat Sedus and make it unusable. To
