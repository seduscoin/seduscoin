    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SEDUS-light"), QVariant("light"));
    ui->theme->addItem(QString("SEDUS-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SEDUS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SEDUS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SEDUS-traditional"), QVariant("trad"));
