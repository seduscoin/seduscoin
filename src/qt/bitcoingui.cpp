    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Sedus Core") + " - ";
#ifdef ENABLE_WALLET
    ...
    {
        progressBar->setStyleSheet("QProgressBar { background-color: #F8F8F8; border: 1px solid grey; border-sedus: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #00CCFF, stop: 1 #33CCFF); border-sedus: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Sedus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and sedus: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Sedus Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sedus Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sedus Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Sedus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Sedus addresses"));
    ...
    openAction->setStatusTip(tr("Open a sedus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sedus Core help message to get a list with possible Sedus Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Sedus Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sedus network", "", count));
    } else {
...
{
    QString strTitle = tr("Sedus Core"); // default title
